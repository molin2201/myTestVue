  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="命中次数" prop="filterCount">
        <el-input
          v-model="queryParams.filterCount"
          placeholder="请输入命中次数"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:filterlog:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:filterlog:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:filterlog:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:filterlog:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="logList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="拦截类型" align="center" prop="filterType" />
      ...
      <el-table-column label="地区" align="center" prop="areaIn" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="地区" prop="areaIn">
          <el-input v-model="form.areaIn" placeholder="请输入地区" />
        </el-form-item>
        <el-form-item label="用户" prop="userId">
...
<script>
import { listLog, getLog, delLog, addLog, updateLog, exportLog } from "@/api/system/filterlog";
